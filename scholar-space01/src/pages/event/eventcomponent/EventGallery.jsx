      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <motion.div {...fadeIn} className="text-center mb-12 md:mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-neutral-900">
            Summer School <span className="text-blue-600">Gallery</span>
          </h2>
          <p className="text-lg md:text-xl text-neutral-600 max-w-3xl mx-auto leading-relaxed">
            Highlights from the ongoing Quantum Computing Summer School 2025,
            showcasing international collaboration, learning sessions, and
            cultural experiences in historic Samarkand.
          </p>
        </motion.div>
